  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <!-- <router-link class="btn" to="/paysuccess">立即支付</router-link> 不直接跳转，要先弹出个二维码窗口 -->
    ...
    async open() {
      ...
      if (!this.timer) {
        ...
        this.timer = setInterval(async () => {
          ...
          console.log(result)
          if (result.code == 200) {
            /*1.清除定时器     2.隐藏二维码弹窗   3.保存支付的状态码
              保存状态码的意义：将来状态码是200的时候，点那个已完成支付才会把遮罩层(弹窗)去除
            */
            clearInterval(this.timer)
            this.timer = null
            this.code = result.code
            //关闭弹窗   暂停关闭见上面的this.$alert
            this.$msgbox.close()
            this.$router.push('/paysuccess')
          }
        }, 1000)
